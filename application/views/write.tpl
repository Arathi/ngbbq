...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="text">
            <div class="write">
                <form action="" method="post" name="write" onsubmit="return verify(this)">
                ...
                <p><input type="submit" name="submit" value="提交匿名表白"/></p>
                </form>
                <br />
                <br />
            </div>
            <div id="foot">Copyright 2014 Boot & Arathi All Rights Reserved.<br />Mail:tyan-bbq@outlook.com</div>
        </div>
    </body>
</html>